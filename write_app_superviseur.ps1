...
'@
$targetPath = Join-Path $PSScriptRoot "app_superviseur.py"
...
if ($firstLine -like "*content = @*") { Write-Host "ERREUR : app_superviseur.py mal ecrit !" -ForegroundColor Red } else { Write-Host "OK : app_superviseur.py ecrit correctement" -ForegroundColor Green }
